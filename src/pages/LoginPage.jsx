    ...
    return (
        ...
        <div className="bg-[#00AA55] h-[100vh] overflow-hidden">
            ...
            <div className="w-full grid grid-cols-3 min-h-screen">
              ...
              <div className="w-full p-12 bg-white border border-gray-200 rounded-3xl shadow flex flex-col gap-8 justify-center items-center">
                <h1 className="text-6xl font-bold">Evenity</h1>
                <form className="space-y-6 mb-10 w-[90%]" onSubmit={handleSubmit(handleLogin)}> {/* Mengganti handleLogin dengan handleSubmit */}
                  <div>
                    <label
                      htmlFor="email"
